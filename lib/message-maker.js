...
// Message processing
exports.getMessage = function(noodle, channel, req, io, userList, messageType, channelList) {
  ...
  this.pushChannel = function(channel) {
    if(this.checkMatchingChannelIdx(channel) === false) {
  ...
  this.checkMatchingChannelIdx = function(channel) {
    console.log('************ ', channel)
